...
//         <Button onClick={() => console}>Instagram</Button>
 ...
 * such things.
 */
// class HomepageHeading extends React.Component<HomepageHeadingProps, {}> {
//   render() {
...
//   private toggleFixedMenu(fixed:boolean) {
...
//         <Visibility once={false} onBottomPassed={ () => this.toggleFixedMenu(true)} 
// onBottomPassedReverse={ () => this.toggleFixedMenu(false)}>
